...
public class MenuValidationParamTests {
	
	private AdvancedWebDriver driver = null;
	private static String menuItemLocation = "C://Users//Onshore//Desktop//Data-Driven//RegressionMenuItemData.csv";
  ...
  public void test1() throws Exception {
	  ...
	  .chooseCafe("60515", "600701").orderForLater(1, "10:15 AM", true).clickCategoryPlacard(menuItemInfo.get(1))
  ...
  /*@Test
  public void before10_30() throws Exception {
	  PageFactory.getDefaultHomePage(driver).startRPUOrder().signIn("chaley.tester","bread3").verifyLogin()
	  .chooseCafe("60515", "600701").orderForLater(1, null, false).clickCategoryPlacard(menuItemInfo.get(1))
	  .orderItem(menuItemInfo.get(3), false, null).goToCheckout().dismissAllModals()
	  .payWithCC(CardTypes.AMEX, null, "manual", null, false).verifySuccessfulOrder();
  }
  
  @Test
  public void after10_30() throws Exception {
	  PageFactory.getDefaultHomePage(driver).startRPUOrder().signIn("chaley.tester","bread3").verifyLogin()
	  .chooseCafe("60515", "600701").orderForLater(1, null, false).clickCategoryPlacard(menuItemInfo.get(1))
	  .orderItem(menuItemInfo.get(3), false, null).goToCheckout().dismissAllModals()
	  .payWithCC(CardTypes.AMEX, null, "manual", null, false).verifySuccessfulOrder();
